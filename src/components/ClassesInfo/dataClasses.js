...
export const dataClasses = [
    {
        ...
        point: ["Leg-split in 2 months", "Makes your muscles elastic", "Burning up to 320 kcal per workout", "Suitable for any skill level", "Result after just a month of regular training", "Reduces stress level"],
        showMore: false,
...

    {
        ...
        searchTerm: "hotyoga",
        point: ["Leg-split in 2 months", "Decreases swelling", "Burning up to 320 kcal per workout", "Suitable for any skill level", "Result after just a month of regular training", "Reduces stress level"],
        showMore: false,
        title: "hot-yoga",
...

    {
        ...
        point: ["Intense fat burning", "Self defense training", "Burning up to 700 kcal per workout", "Suitable for any skill level", "Result after just a month of regular training", "Improved psychological state"],
        showMore: false,
        title: "fit-boxing",
    ...
    },
    {
        ...
        searchTerm: "yoga",
        point: ["Improved body and workimg through blocks", "Working out all muscle groups", "Working with posture problems", "Improved flexibility, endurance and strength", "Suitable for any skill level", "Increased concentration and decreased anxiety"],
        showMore: false,
        title: "yoga",
    ...
    },
    {
        ...
        point: ["Leg-split in 2 months", "Improves coordination", "Improved flexibility, endurance and strength", "Suitable for any skill level", "Result after just a month of regular training", "Reduces stress level"],
        showMore: false,
        title: "stretching",
...

    {
        ...
        searchTerm: "personal",
        point: ["Working with your weight and body", "Improves coordination", "Burning up to 750 kcal per workout", "Suitable for any skill level", "Result after just a month of regular training", "Reduces stress level"],
        showMore: false,
...

    {
        ...
        searchTerm: "pilates",
        point: ["Working with your weight and body", "Improves coordination", "Improved flexibility, endurance and strength", "Suitable for any skill level", "Result after just a month of regular training", "Reduces stress level"],
        showMore: false,
        title: "pilates",
...

    {
        ...
        searchTerm: "trx",
        point: ["Working with your weight", "Working out all muscle groups", "Burning up to 800 kcal per workout", "Suitable for any skill level", "Result after just a month of regular training", "More than 1000 different excercises"], 
        showMore: false,
        title: "trx",
...

    {
        ...
        searchTerm: "aero",
        point: ["Improves stretching", "Author's complex for stretching and strengthening the back", "Burning up to 400 kcal per workout", "Relieving stress from the spine", "Anti-aging and anti-cellulite effect from training", "Blood circulation improves"],
        showMore: false,
        title: "aero",
...

    {
        ...
        searchTerm: "mfr",
        point: ["Working with your weight", "Working out all muscle groups", "Burning up to 550 kcal per workout", "Relaxation of deep muscles and fascia", "Result after just a month of regular training", "Blood circulation improves"],
        showMore: false,
        title: "tabata-mfr",
        description: "Intense strength training in load alternating mode. You do not need any additional equipment for the classes, and the effect is simply amazing, you will work out all muscle groups, develop coordination and endurance, and increase the rate of fat burning. For a comprehensive approach and improved recovery, we have added classes on MFR rolls, what is it? MFR or myofascial release is manual therapy and includes a special massage and self-massage technique that relaxes deep muscles and fascia."
    }
]